Copyright (c) 2025-present Spectral Lab
Copyright (c) 2025-present Gael Goy
...
- All third-party components incorporated into the Software are licensed
  under the original license provided by their respective owners.

- Content outside of the above-mentioned directories or restrictions
  is licensed under the GNU Affero General Public License, version 3 (AGPL-3.0).

Trademarks:
The names BookCreator, AutomaticBook and Spectral are trademarks of Spectral Lab.
They may be used freely to refer to or distribute the official open source software.
Any commercial use of these trademarks requires prior written permission.

SaaS usage:
Use of this software to operate a paid cloud service (SaaS) is expected to be
covered by an enterprise license from Spectral Lab, which provides additional
rights, branding permissions, and professional support.
